...
function getSuggestedEndpoints(environment) {
  ...
  const localEndpoint = `/api/facturas?environment=${environment}`;
  if (!instance) return { create: localEndpoint, update: localEndpoint, localEndpoint };
  return {
    create: `https://${instance}/services/data/v${apiVersion}/sobjects/Factura__c`,
    updateExternalId: `https://${instance}/services/data/v${apiVersion}/sobjects/Factura__c/Numero_de_Factura__c/{Numero_de_Factura__c}`,
    updateAltExternalId: `https://${instance}/services/data/v${apiVersion}/sobjects/Factura__c/External_ID__c/{External_ID__c}`,
    updateSalesforceId: `https://${instance}/services/data/v${apiVersion}/sobjects/Factura__c/{Id}`,
    localEndpoint,
  };
}
