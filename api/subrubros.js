...
function getSuggestedEndpoints(environment) {
  ...
  const localEndpoint = `/api/subrubros?environment=${environment}`;
  if (!instance) return { create: localEndpoint, update: localEndpoint, localEndpoint };
  return {
    create: `https://${instance}/services/data/v${apiVersion}/sobjects/Subrubro__c`,
    updateExternalId: `https://${instance}/services/data/v${apiVersion}/sobjects/Subrubro__c/External_ID__c/{External_ID__c}`,
    updateSalesforceId: `https://${instance}/services/data/v${apiVersion}/sobjects/Subrubro__c/{Id}`,
    localEndpoint,
  };
}
