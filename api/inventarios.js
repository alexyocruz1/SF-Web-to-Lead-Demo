...
function getSuggestedEndpoints(environment) {
  ...
  const localEndpoint = `/api/inventarios?environment=${environment}`;
  if (!instance) return { create: localEndpoint, update: localEndpoint, localEndpoint };
  return {
    create: `https://${instance}/services/data/v${apiVersion}/sobjects/Inventario__c`,
    updateExternalId: `https://${instance}/services/data/v${apiVersion}/sobjects/Inventario__c/External_ID__c/{External_ID__c}`,
    updateSalesforceId: `https://${instance}/services/data/v${apiVersion}/sobjects/Inventario__c/{Id}`,
    localEndpoint,
  };
}
