...
function getSuggestedEndpoints(environment) {
  ...
  const localEndpoint = `/api/sucursales?environment=${environment}`;
  if (!instance) return { create: localEndpoint, update: localEndpoint, localEndpoint };
  return {
    create: `https://${instance}/services/data/v${apiVersion}/sobjects/Sucursal__c`,
    updateExternalId: `https://${instance}/services/data/v${apiVersion}/sobjects/Sucursal__c/External_ID__c/{External_ID__c}`,
    updateSalesforceId: `https://${instance}/services/data/v${apiVersion}/sobjects/Sucursal__c/{Id}`,
    localEndpoint,
  };
}
