...
function getSuggestedEndpoints(environment) {
  ...
  const localEndpoint = `/api/pricebookentries?environment=${environment}`;
  if (!instance) return { create: localEndpoint, update: localEndpoint, localEndpoint };
  return {
    create: `https://${instance}/services/data/v${apiVersion}/sobjects/PricebookEntry`,
    updateExternalId: `https://${instance}/services/data/v${apiVersion}/sobjects/PricebookEntry/External_ID__c/{External_ID__c}`,
    updateSalesforceId: `https://${instance}/services/data/v${apiVersion}/sobjects/PricebookEntry/{Id}`,
    localEndpoint,
  };
}
